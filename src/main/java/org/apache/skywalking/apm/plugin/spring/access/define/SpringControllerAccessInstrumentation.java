...
package org.apache.skywalking.apm.plugin.spring.access.define;
...
import org.apache.skywalking.apm.plugin.spring.access.ClassAnnotationAnyMatch;
...
public class SpringControllerAccessInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
                ...
                new InstanceMethodsInterceptPoint() {
                    ...
                    public ElementMatcher<MethodDescription> getMethodsMatcher() {
                        return byMethodInheritanceAnnotationMatcher(named("org.springframework.web.bind.annotation.RequestMapping"))
                                .or(byMethodInheritanceAnnotationMatcher(named("org.springframework.web.bind.annotation.GetMapping")))
                    ...
                    public String getMethodsInterceptor() {
                        return "org.apache.skywalking.apm.plugin.spring.access.SpringControllerAccessInterceptor";
                    }
    ...
    public ClassMatch enhanceClass() {
        String[] enhanceAnnotations = getEnhanceAnnotations();
        return ClassAnnotationAnyMatch.byClassAnnotationAnyMatch(enhanceAnnotations);
    }
